...
function App() {
  ...
  return (
    <div className="relative">
      <header
        className="fixed left-0 right-0 top-0 z-20 w-100"
        id="home"
      >
      ...
      <main className="relative mt-28">
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hello, I'm Awang</h2>
              <div>
              <h2 className="font-bold text-4xl mt-1 gradiant-text">frontend developer</h2>
              </div>
              <div>
              <p className="mt-4 text-gray-400">
                Frontend Developer, seeking to apply competent development
                skills with a focus on collaboration, communication, and
                expertise.
              </p>
